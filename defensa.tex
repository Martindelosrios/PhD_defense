...
\begin{figure}[ht!]
 \centering
 \includegraphics[scale=0.38]{a267_paper.png}
 % a2029_paper.png: 1094x200 px, 96dpi, 28.94x5.29 cm, bb=0 0 820 150
\end{figure}
}
\frame{
...
\begin{columns}
 \begin{column}{5cm}
  \begin{figure}[ht!]
   \centering
   \includegraphics[scale=0.3]{./cosmo_parameters.png}
  \end{figure}
 \end{column}
 \begin{column}{5cm}
  \begin{figure}[ht!]
   \centering
   \includegraphics[scale=0.3]{./fig3_trainset.pdf}
  \end{figure}
 \end{column}
\end{columns}
}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[scale=0.22]{./H_pred_fullsky_pixels_svm_8comp_sn.pdf}
 \includegraphics[scale=0.22]{./omc_pred_fullsky_pixels_svm_8comp_sn.pdf}
 \includegraphics[scale=0.22]{./omb_pred_fullsky_pixels_svm_8comp_sn.pdf}
 \includegraphics[scale=0.22]{./omk_pred_fullsky_pixels_svm_8comp_sn.pdf}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[scale=0.2]{./tau_pred_fullsky_pixels_svm_8comp_sn.pdf}
 \includegraphics[scale=0.2]{./n_pred_fullsky_pixels_svm_8comp_sn.pdf}
 \includegraphics[scale=0.2]{./As_pred_fullsky_pixels_svm_8comp_sn.pdf}
 \includegraphics[scale=0.2]{./at_pred_fullsky_pixels_svm_8comp_sn.pdf}
 % As_pred_fullsky_pixels_svm_8comp_sn.pdf: 0x0 pixel, 300dpi, 0.00x0.00 cm, bb=
\end{figure}
}
...
\begin{figure}[ht!]
 \centering
 \includegraphics[scale=0.25]{./planck_omk_pred_mask.pdf}
 \includegraphics[scale=0.25]{./planck_tau_pred_mask.pdf}
 \includegraphics[scale=0.25]{./planck_As_pred_mask.pdf}
 \includegraphics[scale=0.25]{./planck_at_pred_mask.pdf}
